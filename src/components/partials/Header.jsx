...
const Header = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <p className="w-[70%] mt-4 text-base sm:text-base md:basel lg:text-base xl:text-base text-white">
      ...
      <p className="text-white mt-3 flex gap-2">
        ...
        <i className="ml-5 text-yellow-600 ri-video-on-fill"></i>
        {mediaType?.toUpperCase()}
      </p>

      <Link
        to={`/${mediaType}/details/${id}/trailer`}
