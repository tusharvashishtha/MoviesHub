  ...
  return (
    <div className="w-[20%] h-full border-r-2 border-zinc-400 p-10">
        ...
        <nav className='flex flex-col text-zinc-400 text-xl gap-2'>
           ...
           <Link className='hover:bg-[#6556CD] hover:text-white duration-400 rounded-lg p-5'><i class="ri-movie-2-fill"></i> Movies</Link>
           <Link className='hover:bg-[#6556CD] hover:text-white duration-400 rounded-lg p-5'><i class="ri-tv-2-fill"></i> Tv Shows</Link>
           <Link className='hover:bg-[#6556CD] hover:text-white duration-400 rounded-lg p-5'><i class="ri-team-fill"></i> People</Link>
        </nav>
